...
-- UI Re-scaled to 650x420 / 3D Box ESP Preserved
-- ==============================================================================
...
RegisterTouchFriendlyClick(SideMenuBtn, function()
    ...
    local TargetMainSize = SettingsExpanded and UDim2.new(0, 650, 0, 420) or UDim2.new(0, 30, 0, 420)
...
for _, page in pairs({CombatPage, PlayerPage, MovementPage, VisualPage, MiscPage, CreditsPage}) do
    ...
    grid.CellSize = UDim2.new(0.5, -12, 0, 38)
